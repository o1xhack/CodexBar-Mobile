...
struct UsageStoreAccountQuotaWarningTests {
    ...
    func `ordinary refresh keeps selected token account warning episodes independent`() async {
        ...
        // This case verifies the selected-account path. iCloud-on refresh deliberately
        // fans out across every token account and is covered by the sync-specific tests.
