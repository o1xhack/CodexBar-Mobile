...
struct MockProviderAdvancedScenariosTests {
    ...
    func mockProvidersAreSubscribable() {
        ...
        // 63 snapshots use real provider IDs (3 codex + 2 claude + 1
        ...
        // Phase G + iOS 1.8.0 + 1.9.0 + 1.12.0 + 1.13.0:
        // 43 → 50 → 55 → 59 → 63.
        #expect(realBorrowedMocks.count == 63)
