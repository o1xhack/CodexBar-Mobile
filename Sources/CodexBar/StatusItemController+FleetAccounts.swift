...
extension StatusItemController {
    ...
    func fleetAccountProjection(for provider: UsageProvider) -> FleetAccountMenuProjection {
        guard self.settings.macFleetSyncEnabled,
              self.settings.macFleetSyncSnapshotsEnabled,
              self.settings.macFleetSyncShowFleetAccounts
        else {
        ...
        return FleetAccountMenuPlanner.projection(
            ...
            currentDeviceID: self.settings.macFleetSyncDeviceID,
