public enum LogCategories {
    ...
    public static let kimi2API = "kimi2-api"
    public static let kimi2Cookie = "kimi2-cookie"
    public static let kimi2TokenStore = "kimi2-token-store"
    public static let kimi2Web = "kimi2-web"
