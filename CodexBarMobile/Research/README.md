...
| 029 | v0.35.0 Upstream Sync + iOS 1.12.0 (open issues #22/#23/#24/#26, v0.32.5-v0.35.0 as one release, MiniMax metadata + Devin/Amp/Copilot/Kimi/MiMo audit) | `in-progress` | — | [029-v035-upstream-sync/00-overview.md](029-v035-upstream-sync/00-overview.md) | 2026-06-14 |
