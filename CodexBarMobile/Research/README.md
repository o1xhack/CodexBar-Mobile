...
| 036 | Widget Completion Audit (data parity, fallback, AppIntent configuration, visual matrix, and release handoff gate) | `in-progress` | SpringBoard configuration-switch automation still needs a stable pass before closure | [036-widget-completion-audit.md](036-widget-completion-audit.md) | 2026-07-02 |
