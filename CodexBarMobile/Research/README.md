...
| 046 | macOS 27 Swift executor crash hardening (fork Mac DiagnosticReports, AppKit callback seams, and deferred menu-bar image drawing) | `in-progress` | Maintainer review and fresh macOS 27 post-fix soak; synchronous menu delegate path remains residual risk | [046-macos-27-executor-crash-hardening/00-overview.md](046-macos-27-executor-crash-hardening/00-overview.md) | 2026-08-09 |
| 046 | Ollama Cloud Sync Durability (empty API fallback preservation, ghost cleanup guard, and legacy CloudKit conflict tolerance) | `done` | PR review/CI and host iOS simulator verification remain separate gates | [046-ollama-cloud-sync-durability/00-overview.md](046-ollama-cloud-sync-durability/00-overview.md) | 2026-08-09 |
| 047 | Ollama Browser Cookie Access Feedback (surface Keychain interaction requirement instead of false signed-out state) | `done` | Draft PR review and signed release remain separate gates | [047-ollama-cookie-access-feedback.md](047-ollama-cookie-access-feedback.md) | 2026-08-09 |
