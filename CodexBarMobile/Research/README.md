...
| 049 | v0.56.0 Upstream Sync + iOS 1.23.0 build 196 (issues #102-#104 plus authoritative v0.56.0; v0.54.1-v0.56.0 as one train; Claude slot migration, provider/cost compatibility and CLI hardening) | `done` | Signed/notarized Mac draft ready; CloudKit `NO_DEPLOY`; substituted 16-case matrix and blocker=0 review complete; push/merge/tag/live release/TestFlight/appcast publish intentionally unperformed | [049-v056-upstream-sync/00-overview.md](049-v056-upstream-sync/00-overview.md) | 2026-08-28 |
