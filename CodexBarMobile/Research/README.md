...
| 037 | v0.39.0 Upstream Sync + iOS 1.17.0 (issue #37, v0.38.0-v0.39.0 as one release, new providers + provider display data + draft release gate) | `in-progress` | GitHub draft release requires remote tag confirmation | [037-v039-upstream-sync/00-overview.md](037-v039-upstream-sync/00-overview.md) | 2026-07-04 |
