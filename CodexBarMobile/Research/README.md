...
| 043 | Alibaba Token Plan Rate Windows Hotfix (issue #59, rolling 5-hour and weekly usage restoration ahead of upstream release) | `in-progress` | Live Alibaba account proof and signed publication remain separate gates | [043-alibaba-token-plan-rate-windows.md](043-alibaba-token-plan-rate-windows.md) | 2026-07-24 |
