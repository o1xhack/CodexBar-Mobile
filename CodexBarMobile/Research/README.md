...
| 048 | v0.54.0 Upstream Sync + iOS 1.21.0 build 195 (issue #95 + Settings defect #97; v0.53.0-v0.54.0 as one train; cost provenance/coverage and provider sync audit) | `done` | Local closure complete; 16-case fleet matrix is substituted, and remote release/PR/TestFlight actions remain separately authorized | [048-v054-upstream-sync/00-overview.md](048-v054-upstream-sync/00-overview.md) | 2026-08-22 |
