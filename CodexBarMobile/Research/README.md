...
| 028 | v0.32.5 Upstream Sync + iOS 1.12.0 (Mac menu/perf/localization fixes, MiniMax subscription metadata, sync compatibility gate) | `in-progress` | — | [028-v0325-upstream-sync/00-overview.md](028-v0325-upstream-sync/00-overview.md) | 2026-06-10 |
