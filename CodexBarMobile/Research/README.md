...
| 047 | v0.52.0 Upstream Sync + iOS 1.21.0 build 194 (issues #82-#88 plus authoritative v0.52.0; same iOS marketing version, provider display/sync and project-cost audit) | `done` | Mac `0.52.0.1` live + signed appcast; iOS `1.21.0 (194)` ASC `VALID`; CloudKit `NO_DEPLOY`; substituted 16-case matrix pass; App Store 1.21.0 build binding pending login | [047-v052-upstream-sync/00-overview.md](047-v052-upstream-sync/00-overview.md) | 2026-08-19 |
