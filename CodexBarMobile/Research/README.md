...
| 042 | v0.45.2 Upstream Sync + iOS 1.19.0 (issues #48/#51 plus authoritative Releases v0.42.0-v0.45.2 as one train) | `in-progress` | None; remote operations remain outside the Goal boundary | [042-v045-upstream-sync/00-overview.md](042-v045-upstream-sync/00-overview.md) | 2026-07-19 |
